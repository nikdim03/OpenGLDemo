...
open class DefaultShape(context: Context, private val isOES: Boolean = true) : BaseShape(context) {
    ...
    override fun initialize() {
        ...
        Log.d(TAG, "initialize: $textureHandle")
    ...
    private companion object {
        private const val TAG = "DefaultShape"
    }
}